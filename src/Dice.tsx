...
function Dice({
    ...
    return (
        <div  className="flex absolute left-[48%] glow top-[5px] bg-neon-green rounded-full p-3">
            <svg className={isLoading ? "animate" : ""} width="24"  fill="red" height="24" xmlns="http://www.w3.org/2000/svg">
